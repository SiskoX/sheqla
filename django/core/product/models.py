...
from .gear import ART_RARITY,ART_CONDITION, BOOK_CONDITION,BUSINESS_INDUSTRIAL,CLOTH_SHOES_WATCHES_CONDITION,ELECTORINCS,FOOD_BEVERAGES_CONDTION,HEALTH_BEAUTY_CONDTION,MOTORS_CONDTIOND,MOVIES_TV_MUSIC_VIDEO_GAMES_CONDTION,SPARE_PARTS,TOY_CONDITION
...
class Cloth(CommonInfo):
    ...
    cloth_fiber_content = models.ForeignKey(Cloth_Fiber_Content,on_delete=models.CASCADE)
...
class Art(CommonInfo):
    ...
    condition  = models.CharField(max_length=50, blank=True, null=True,choices= ART_CONDITION)
